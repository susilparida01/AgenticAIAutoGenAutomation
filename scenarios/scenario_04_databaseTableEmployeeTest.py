...
SCENARIO_META = {
    "name":        "Scenario_04 - MySQL Employees Data Query",
    "description": "Connects to the bakery_hr database and verifies that Anita Rao, Peter Shaw, and Rahul Mehta employees exist.",
}
...
async def main():
    ...
    database_agent = await factory.create_database_agent(
        system_message=("""
                                        ...
                                        2. Query the table: employees
                                        3. Retrieve employees records.
                                        ...
                                        Finish by writing: EMPLOYEES_DATA_READY
                                    """)
    )

    team = RoundRobinGroupChat(
        participants=[database_agent],
        termination_condition=TextMentionTermination("EMPLOYEES_DATA_READY"),
    )
    ...
    await run_scenario_with_report(
        ...
        task=(
            ...
            Actions:
            1. Query the table: employees.
            2. Retrieve employees name data.
            3. Print the employees records in a clear table format.
            
            Validation:
            1. Verify the table contains the following employees names:
               - Anita Rao
               - Peter Shaw
               - Rahul Mehta
            2. Confirm all three employees exist in the results.
            
            Output:
            - Display the retrieved employees data.
            - Report validation result:
              PASS if Anita Rao, Peter Shaw, and Rahul Mehta are present.
              FAIL if any employee is missing.
            
            End with: EMPLOYEES_VALIDATION_COMPLETE            
            """
        ),
        pass_condition_text="EMPLOYEES_DATA_READY",
    )
